...
public class InstanceValidator extends BaseValidator implements IResourceValidator {
  ...
  private void checkCoding(List<ValidationMessage> errors, String path, WrapperElement element, StructureDefinition profile, ElementDefinition theElementCntext, boolean inCodeableConcept)  {
	...
	private void checkFixedValue(List<ValidationMessage> errors, String path, WrapperElement focus, org.hl7.fhir.dstu21.model.Element fixed, String propName) {
		if (fixed == null && focus == null)
			...
			if (fixed instanceof org.hl7.fhir.dstu21.model.BooleanType)
				rule(errors, IssueType.VALUE, focus.line(), focus.col(), path, check(((org.hl7.fhir.dstu21.model.BooleanType) fixed).asStringValue(), value),
						"Value is '" + value + "' but must be '" + ((org.hl7.fhir.dstu21.model.BooleanType) fixed).asStringValue() + "'");
			else if (fixed instanceof org.hl7.fhir.dstu21.model.IntegerType)
				rule(errors, IssueType.VALUE, focus.line(), focus.col(), path, check(((org.hl7.fhir.dstu21.model.IntegerType) fixed).asStringValue(), value),
						"Value is '" + value + "' but must be '" + ((org.hl7.fhir.dstu21.model.IntegerType) fixed).asStringValue() + "'");
			else if (fixed instanceof org.hl7.fhir.dstu21.model.DecimalType)
				rule(errors, IssueType.VALUE, focus.line(), focus.col(), path, check(((org.hl7.fhir.dstu21.model.DecimalType) fixed).asStringValue(), value),
						"Value is '" + value + "' but must be '" + ((org.hl7.fhir.dstu21.model.DecimalType) fixed).asStringValue() + "'");
			else if (fixed instanceof org.hl7.fhir.dstu21.model.Base64BinaryType)
				rule(errors, IssueType.VALUE, focus.line(), focus.col(), path, check(((org.hl7.fhir.dstu21.model.Base64BinaryType) fixed).asStringValue(), value),
						"Value is '" + value + "' but must be '" + ((org.hl7.fhir.dstu21.model.Base64BinaryType) fixed).asStringValue() + "'");
			else if (fixed instanceof org.hl7.fhir.dstu21.model.InstantType)
				rule(errors, IssueType.VALUE, focus.line(), focus.col(), path, check(((org.hl7.fhir.dstu21.model.InstantType) fixed).getValue().toString(), value),
						"Value is '" + value + "' but must be '" + ((org.hl7.fhir.dstu21.model.InstantType) fixed).asStringValue() + "'");
			else if (fixed instanceof org.hl7.fhir.dstu21.model.StringType)
				rule(errors, IssueType.VALUE, focus.line(), focus.col(), path, check(((org.hl7.fhir.dstu21.model.StringType) fixed).getValue(), value),
						"Value is '" + value + "' but must be '" + ((org.hl7.fhir.dstu21.model.StringType) fixed).getValue() + "'");
			else if (fixed instanceof org.hl7.fhir.dstu21.model.UriType)
				rule(errors, IssueType.VALUE, focus.line(), focus.col(), path, check(((org.hl7.fhir.dstu21.model.UriType) fixed).getValue(), value),
						"Value is '" + value + "' but must be '" + ((org.hl7.fhir.dstu21.model.UriType) fixed).getValue() + "'");
			else if (fixed instanceof org.hl7.fhir.dstu21.model.DateType)
				rule(errors, IssueType.VALUE, focus.line(), focus.col(), path, check(((org.hl7.fhir.dstu21.model.DateType) fixed).getValue().toString(), value),
						"Value is '" + value + "' but must be '" + ((org.hl7.fhir.dstu21.model.DateType) fixed).getValue() + "'");
			else if (fixed instanceof org.hl7.fhir.dstu21.model.DateTimeType)
				rule(errors, IssueType.VALUE, focus.line(), focus.col(), path, check(((org.hl7.fhir.dstu21.model.DateTimeType) fixed).getValue().toString(), value),
						"Value is '" + value + "' but must be '" + ((org.hl7.fhir.dstu21.model.DateTimeType) fixed).getValue() + "'");
			else if (fixed instanceof org.hl7.fhir.dstu21.model.OidType)
				rule(errors, IssueType.VALUE, focus.line(), focus.col(), path, check(((org.hl7.fhir.dstu21.model.OidType) fixed).getValue(), value),
						"Value is '" + value + "' but must be '" + ((org.hl7.fhir.dstu21.model.OidType) fixed).getValue() + "'");
			else if (fixed instanceof org.hl7.fhir.dstu21.model.UuidType)
				rule(errors, IssueType.VALUE, focus.line(), focus.col(), path, check(((org.hl7.fhir.dstu21.model.UuidType) fixed).getValue(), value),
						"Value is '" + value + "' but must be '" + ((org.hl7.fhir.dstu21.model.UuidType) fixed).getValue() + "'");
			else if (fixed instanceof org.hl7.fhir.dstu21.model.CodeType)
				rule(errors, IssueType.VALUE, focus.line(), focus.col(), path, check(((org.hl7.fhir.dstu21.model.CodeType) fixed).getValue(), value),
						"Value is '" + value + "' but must be '" + ((org.hl7.fhir.dstu21.model.CodeType) fixed).getValue() + "'");
			else if (fixed instanceof org.hl7.fhir.dstu21.model.IdType)
				rule(errors, IssueType.VALUE, focus.line(), focus.col(), path, check(((org.hl7.fhir.dstu21.model.IdType) fixed).getValue(), value),
						"Value is '" + value + "' but must be '" + ((org.hl7.fhir.dstu21.model.IdType) fixed).getValue() + "'");
  ...
  private String checkResourceType(String type)  {
	...
	private boolean empty(WrapperElement element, boolean logicalMode, String namespace) {
		if (element.hasAttribute("value"))
			return false;
    ...
    if (logicalMode) {
      if (element.hasText())
        return false;
      if (element.hasSomeAttribute())
        return false;
    }
    
		WrapperElement child = element.getFirstChild();
		while (child != null) {
			if (!child.isXml() || namespace.equals(child.getNamespace())) {
				return false;
			}
  ...
  private String getBaseType(StructureDefinition profile, String pr)  {
	...
	private ElementDefinition getCriteriaForDiscriminator(String path, ElementDefinition ed, String discriminator, StructureDefinition profile) throws DefinitionException, org.hl7.fhir.dstu21.exceptions.DefinitionException {
 ...
 * @throws DefinitionException 
	 ...
	 * @throws Exception
	 */
	private boolean sliceMatches(WrapperElement element, String path, ElementDefinition slice, ElementDefinition ed, StructureDefinition profile) throws DefinitionException, DefinitionException {
	...
	private void start(List<ValidationMessage> errors, WrapperElement resource, WrapperElement element, StructureDefinition profile, NodeStack stack) throws FHIRException, FHIRException {
  ...
  private String tryParse(String ref)  {
	...
	@Override
	public List<ValidationMessage> validate(Document document, String profile) throws FHIRException, DefinitionException {
		List<ValidationMessage> results = new ArrayList<ValidationMessage>();
	...
	@Override
	public List<ValidationMessage> validate(Document document, StructureDefinition profile) throws FHIRException, FHIRException {
		List<ValidationMessage> results = new ArrayList<ValidationMessage>();
		validate(results, document, profile);
		return results;
	}       

  public List<ValidationMessage> validateLogical(Document document, Bundle logical) throws FHIRException, FHIRException {
    this.logical = logical;
    List<ValidationMessage> results = new ArrayList<ValidationMessage>();
    validateLogical(results, document);
    return results;
  }       

	@Override
	public List<ValidationMessage> validate(Element element) throws FHIRException, FHIRException {
		List<ValidationMessage> results = new ArrayList<ValidationMessage>();
	...
	@Override
	public List<ValidationMessage> validate(Element element, String profile) throws FHIRException, FHIRException {
		List<ValidationMessage> results = new ArrayList<ValidationMessage>();
	...
	@Override
	public List<ValidationMessage> validate(Element element, StructureDefinition profile) throws FHIRException, FHIRException {
		List<ValidationMessage> results = new ArrayList<ValidationMessage>();
		validate(results, element, profile);
		return results;
	}
	...
	@Override
	public List<ValidationMessage> validate(JsonObject obj) throws FHIRException, FHIRException {
		List<ValidationMessage> results = new ArrayList<ValidationMessage>();
	...
	@Override
	public List<ValidationMessage> validate(JsonObject obj, String profile) throws FHIRException, FHIRException {
		List<ValidationMessage> results = new ArrayList<ValidationMessage>();
	...
	@Override
	public List<ValidationMessage> validate(JsonObject obj, StructureDefinition profile) throws FHIRException, FHIRException {
		List<ValidationMessage> results = new ArrayList<ValidationMessage>();
		validate(results, obj, profile);
		return results;
	}
	...
	@Override
	public void validate(List<ValidationMessage> errors, Document document) throws FHIRException, FHIRException {
	...
	@Override
	public void validate(List<ValidationMessage> errors, Document document, String profile) throws FHIRException, FHIRException {
		checkForProcessingInstruction(errors, document);
	...
	@Override
	public void validate(List<ValidationMessage> errors, Document document, StructureDefinition profile) throws FHIRException, FHIRException {
		checkForProcessingInstruction(errors, document);
		validateResource(errors, null, new DOMWrapperElement(document.getDocumentElement()), profile, resourceIdRule, null);
	}

  public void validateLogical(List<ValidationMessage> errors, Document document) throws FHIRException, FHIRException {
    DOMWrapperElement w = new DOMWrapperElement(document.getDocumentElement());
    // choose the right entry point:
    StructureDefinition entry = null;
    for (BundleEntryComponent be : logical.getEntry()) {
      if (be.hasResource() && be.getResource() instanceof StructureDefinition) {
        StructureDefinition sd = (StructureDefinition) be.getResource();
        String ns = getNamespace(sd);
        String n = sd.getDifferential().getElement().get(0).getPath();
        if (ns.equals(w.getNamespace()) && n.equals(w.getName()))
          entry = sd;
      }
    }
    if (fail(errors, IssueType.STRUCTURE, w.line(), w.col(), "/", entry != null, "No match for "+w.getNamespace()+"#"+w.getName()+" in the provided logical definitions"))
      validateResource(errors, null, w, entry, resourceIdRule, null);
  }
  ...
  @Override
	public void validate(List<ValidationMessage> errors, Element element) throws FHIRException, FHIRException {
		validateResource(errors, null, new DOMWrapperElement(element), null, resourceIdRule, null);
	}

	@Override
	public void validate(List<ValidationMessage> errors, Element element, String profile) throws FHIRException, FHIRException {
		StructureDefinition p = context.fetchResource(StructureDefinition.class, profile);
		if (p == null)
			throw new DefinitionException("StructureDefinition '" + profile + "' not found");
	...
	@Override
	public void validate(List<ValidationMessage> errors, Element element, StructureDefinition profile) throws FHIRException, FHIRException {
		validateResource(errors, null, new DOMWrapperElement(element), profile, resourceIdRule, null);
	}

	@Override
	public void validate(List<ValidationMessage> errors, JsonObject object) throws FHIRException, FHIRException {
		validateResource(errors, null, new JsonWrapperElement(object), null, resourceIdRule, null);
	}

	@Override
	public void validate(List<ValidationMessage> errors, JsonObject object, String profile) throws FHIRException, FHIRException {
		StructureDefinition p = context.fetchResource(StructureDefinition.class, profile);
		if (p == null)
			throw new DefinitionException("StructureDefinition '" + profile + "' not found");
	...
	@Override
	public void validate(List<ValidationMessage> errors, JsonObject object, StructureDefinition profile) throws FHIRException, FHIRException {
  ...
  // private ValueSet resolveValueSetReference(StructureDefinition profile, Reference reference)  {
	...
	private void validateContains(List<ValidationMessage> errors, String path, ElementDefinition child, ElementDefinition context, WrapperElement resource, WrapperElement element, NodeStack stack, IdStatus idstatus) throws FHIRException, FHIRException
			{
	...
	private void validateElement(List<ValidationMessage> errors, StructureDefinition profile, ElementDefinition definition, StructureDefinition cprofile, ElementDefinition context,
			WrapperElement resource, WrapperElement element, String actualType, NodeStack stack, boolean inCodeableConcept) throws FHIRException, FHIRException {
		element.setDefinition(definition);
		element.setProfile(profile);

		String namespace = getNamespace(profile);
		// irrespective of what element it is, it cannot be empty
		if (element.isXml()) {
			rule(errors, IssueType.INVALID, element.line(), element.col(), stack.getLiteralPath(), namespace.equals(element.getNamespace()),
					"Namespace mismatch - expected '" + namespace + "', found '" + element.getNamespace() + "'");
			rule(errors, IssueType.INVALID, element.line(), element.col(), stack.getLiteralPath(), !element.hasNamespace("http://www.w3.org/2001/XMLSchema-instance") || logical != null,
		...
		rule(errors, IssueType.INVALID, element.line(), element.col(), stack.getLiteralPath(), !empty(element, logical != null, namespace), "Elements must have some content (@value, extensions, or children elements)");
	 ...
	 */
	private void validateResource(List<ValidationMessage> errors, WrapperElement resource, WrapperElement element, StructureDefinition profile, IdStatus idstatus, NodeStack stack) throws FHIRException, FHIRException {
		if (stack == null)
		...
		boolean ok = true;
		if (element.isXml()) {
			ok = rule(errors, IssueType.INVALID, element.line(), element.col(), "/", element.getNamespace().equals(getNamespace(profile)),
					"Namespace mismatch - expected '" + getNamespace(profile) + "', found '" + element.getNamespace() + "'");
		}
		if (ok) {
    ...
    public boolean hasText() {
      return !Utilities.noString(element.getTextContent().trim());
    }
    ...
    public boolean hasSomeAttribute() {
      for (int i = 0; i < element.getAttributes().getLength(); i++) {
        Node a = element.getAttributes().item(i);
        if (!Utilities.existsInList(a.getNodeName(), "xsi:type"))
          return true;
      }
      return false;
    }
    ...
    public abstract boolean hasSomeAttribute();
