...
public class IgSpreadsheetParser {
  ...
  private void checkOutputs() throws Exception {
    if (first)
      System.out.println("Resources generated by processing "+name+":");
    for (BundleEntryComponent be : bundle.getEntry()) {
      ...
      if (first)
        System.out.println("  "+b.getUrl()+" (\""+b.getName()+"\")");
    }
  }
...
//        }
  ...
  private void loadMetadata() throws Exception {
    ...
    if (!hasMetadata("extension.uri") || !metadata("extension.uri").startsWith(base))
      System.out.println("extension.uri must be defined for IG spreadsheets, and must start with "+base);
  }
