  ...
  private String generateStatusMessage(List<String> exempt) {
    ...
    if (exempt != null)
      return "<p id=\"publish-box-current\">This is the current officially released version of FHIR, which is <a href=\"history.html\">"+sequence+
          "</a> (v"+version+"). For a full list of all versions, see the <a href=\"http://hl7.org/fhir/directory.cfml\">Directory of published versions <img src=\"{pd}external.png\" style=\"text-align: baseline\"></a>.</p>";
    ...
    if (lastInSequence) {
      if (ver == currentVer)
        return "<p id=\"publish-box-milestone\">This page is part of FHIR "+sequence+" - the current version v"+version+" - in it's permanent home (it will always be available at this URL). "+
             ...
             "<a href=\"http://hl7.org/fhir/directory.html\">Directory of published versions <img style=\"text-align: baseline\" src=\"{pd}external.png\"></a>.</p>";
      else
