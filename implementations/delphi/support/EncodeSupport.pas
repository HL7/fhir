...
//
// [CH] 17 July 2000
//  + Imported into Library v3.0
//
// [CH] 30 January 2003
//  + Added EncodeUU/DecodeUU
//
...
Uses
  SysUtils,
  StringSupport, MathSupport, NetworkSupport;
...
Function DecodeBase64(Const sValue : AnsiString) : TBytes;
Begin
...
Function EncodeBase64(Const sValue : TBytes) : AnsiString;
Begin
