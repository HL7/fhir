...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DataElement/f:mapping">
      ...
      <sch:assert test="exists(f:uri) or exists(f:name)">At least one of  name or uri SHALL be present (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    ...
    <sch:rule context="f:DataElement/f:element">
      ...
      <sch:assert test="count(f:sliceName) &lt;= 0">sliceName: maximum cardinality of 'sliceName' is 0</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:DataElement/f:element/f:extension</sch:title>
    <sch:rule context="f:DataElement/f:element/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      ...
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:url) &lt;= 1">url: maximum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:valueInteger) &lt;= 1">valueInteger: maximum cardinality of 'valueInteger' is 1</sch:assert>
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:url) &lt;= 1">url: maximum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:valueString) &lt;= 1">valueString: maximum cardinality of 'valueString' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:DataElement/f:element/f:slicing/f:discriminator</sch:title>
    <sch:rule context="f:DataElement/f:element/f:slicing/f:discriminator">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>DataElement.element.slicing.discriminator</sch:title>
    <sch:rule context="f:DataElement/f:element/f:slicing/f:discriminator">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern>
    <sch:title>DataElement.element.base</sch:title>
    <sch:rule context="f:DataElement/f:element/f:base">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    ...
    <sch:rule context="f:DataElement/f:element/f:type">
      ...
      <sch:assert test="count(f:targetProfile) &lt;= 0">targetProfile: maximum cardinality of 'targetProfile' is 0</sch:assert>
      <sch:assert test="count(f:versioning) &lt;= 0">versioning: maximum cardinality of 'versioning' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>f:DataElement/f:element/f:example</sch:title>
    <sch:rule context="f:DataElement/f:element/f:example">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>DataElement.element.example</sch:title>
    <sch:rule context="f:DataElement/f:element/f:example">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern>
    <sch:title>DataElement.element.constraint</sch:title>
    <sch:rule context="f:DataElement/f:element/f:constraint">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DataElement/f:element/f:mapping">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/elementdefinition-equivalence']) &gt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/elementdefinition-equivalence': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/elementdefinition-equivalence']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/elementdefinition-equivalence': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>DataElement.element.mapping</sch:title>
    <sch:rule context="f:DataElement/f:element/f:mapping">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
